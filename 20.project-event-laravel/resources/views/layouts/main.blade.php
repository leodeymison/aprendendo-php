            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        @auth
                            <li class="nav-item">
                                <a class="nav-link text-white" href="/event-create">CRIAR EVENTOS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="/dashboard">MEU EVENTOS</a>
                            </li>
                            <li class="nav-item">
                                <form action="/logout" method="POST">
                                    @csrf
                                    <a onclick="event.preventDefault(); this.closest('form').submit();"
                                        class="nav-link text-danger" href="/logout">SAIR</a>
                                </form>
                            </li>
                        @endauth
                        @guest
